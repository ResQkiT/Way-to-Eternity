...
def GetJavaFILEpath(path):
    #Сигнатура 
    #java -classpath  D:\ilya\java\Way-to-Eternity\FirstWay\target\classes solution1.org.resk.first.Solution1
...
def runJavaFile(path):
    proc = subprocess.Popen(["java",  "-classpath",  "D:\\ilya\\java\\Way-to-Eternity\\FirstWay\\target\\classes", "solution1.org.resk.first.Solution1"])
    for i in range(20):
        proc.send_signal(i)
